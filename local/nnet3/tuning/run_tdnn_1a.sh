...
#for f in $train_data_dir/feats.scp $train_ivector_dir/ivector_online.scp $gmm_dir/{graph_tgpr,graph_bd_tgpr}/HCLG.fst $ali_dir/ali.1.gz $gmm_dir/final.mdl; do
for f in $train_data_dir/feats.scp $train_ivector_dir/ivector_online.scp $gmm_dir/graph/HCLG.fst $ali_dir/ali.1.gz $gmm_dir/final.mdl; do
